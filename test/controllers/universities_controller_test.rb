...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { country_id: @university.country_id, language_id: @university.language_id, name: @university.name }
    end
  ...
  test "should update university" do
    patch :update, id: @university, university: { country_id: @university.country_id, language_id: @university.language_id, name: @university.name }
    assert_redirected_to university_path(assigns(:university))
  end
